...
$(document).ready(function() {
    ...
    $loading_msg.delay(200).animate({ 'opacity': 1 }, 500);
    initPhotoSwipeFromDOM('.msnry');
    $(".msnry__item a").css("pointer-events", "none");
});

$container.imagesLoaded(function() {
    $container.animate({'opacity': 1 }, 500);
    $loading_msg.css("display", "none");
    $(".msnry__item a").css("pointer-events", "initial");
    allow_gallery_open = true;
    $container.masonry({
